            ...
            <div class="page__container">
                        ...
                        <div>
                            <div class="page__head">
                                <div class="page__title h6">Support Staff</div>
                            ...
                            <div class="page_description">
                                Support Staff's requests managed by the Admin
                            </div>
                                            ...
                                            <div class="modal__fieldset">
                                                <div>
                                                    <div class="modal__field">
                                                        ...
                                                        <div class="modal__wrap"><input class="modal__input" type="text" name="title" placeholder="e.g Mr. Adiele Nnamdi" required></div>
                                                    </div>
                                                </div>
                                                <div>
